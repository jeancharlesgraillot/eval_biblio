...
<div class="container border border-secondary pt-3 mb-3">
    <a href="userDetails.php">
        <div class="row text-center">
            ...
            <p class="col-12 col-md-6 col-lg-3">Prénom : </p>
            <p class="col-12 col-md-6 col-lg-3">Nom : </p>
            <p class="col-12 col-md-6 col-lg-3">Identifiant : </p>
...
<div class="container border border-secondary pt-3">
    <a href="userDetails.php">
        <div class="row text-center">
